...
export const InstagramIcon = ({ className, ...rest }) => {
  return (
    ...
    >
      <path
        fill="#E4405F"
        d="M21 2.688c5.422 0 6.07.02 8.211.12 1.983.092 3.059.422 3.775.7.95.367 1.628.806 2.34 1.518.712.712 1.151 1.39 1.518 2.34.278.716.608 1.792.7 3.775.1 2.14.12 2.79.12 8.21s-.02 6.07-.12 8.21c-.092 1.983-.422 3.06-.7 3.776-.367.95-.806 1.627-1.518 2.34-.712.711-1.39 1.15-2.34 1.517-.716.278-1.792.608-3.775.7-2.14.1-2.79.12-8.21.12s-6.07-.02-8.211-.12c-1.983-.092-3.059-.422-3.775-.7a6.304 6.304 0 0 1-2.34-1.518 6.304 6.304 0 0 1-1.518-2.34c-.278-.716-.608-1.793-.7-3.775-.1-2.14-.12-2.79-.12-8.211s.02-6.07.12-8.211c.092-1.983.422-3.06.7-3.775.367-.95.806-1.628 1.518-2.34.712-.712 1.39-1.151 2.34-1.518.716-.278 1.792-.608 3.775-.7 2.14-.1 2.79-.12 8.211-.12Zm0 3.797c-5.33 0-5.961.02-8.065.116-1.944.09-3 .413-3.702.686-.932.361-1.597.793-2.296 1.492-.699.699-1.131 1.364-1.492 2.296-.273.702-.596 1.758-.686 3.702-.096 2.104-.116 2.735-.116 8.065s.02 5.96.116 8.064c.09 1.945.413 3 .686 3.703.361.932.793 1.597 1.492 2.296.699.699 1.364 1.131 2.296 1.492.702.273 1.758.596 3.702.686 2.104.096 2.735.116 8.065.116s5.96-.02 8.064-.116c1.945-.09 3-.413 3.703-.686a6.18 6.18 0 0 0 2.296-1.492 6.18 6.18 0 0 0 1.492-2.296c.273-.702.596-1.758.686-3.703.096-2.103.116-2.735.116-8.064s-.02-5.961-.116-8.065c-.09-1.944-.413-3-.686-3.702a6.18 6.18 0 0 0-1.492-2.296 6.18 6.18 0 0 0-2.296-1.492c-.702-.273-1.758-.596-3.703-.686-2.103-.096-2.734-.116-8.064-.116Zm0 6.465a11.05 11.05 0 1 1 0 22.1 11.05 11.05 0 0 1 0-22.1Zm0 18.22a7.17 7.17 0 1 0 0-14.34 7.17 7.17 0 0 0 0 14.34Zm11.486-18.66a2.583 2.583 0 1 1-5.166 0 2.583 2.583 0 0 1 5.166 0Z"
      />
    </svg>
  );
};
